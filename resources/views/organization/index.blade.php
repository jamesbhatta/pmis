...
<nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">@lang('navigation.offices')</li>
    </ol>
</nav>
@endsection
    ...
    <div class="box">
        <div class="box__header">
            <div class="d-flex align-items-center">
                <div>
                    <h3 class="box__title">@lang('navigation.offices')</h3>
                </div>
                <div class="ml-auto">
                    ...
                    <tr class="bg-white">
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                ...
                                <form action="{{ route('organization.destroy',$organization) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure want to delete?')">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-danger btn-md font-noto my-0 py-2 px-3 z-depth-0" type="submit">Delete</button>
                                </form>
                            </div>
                        </td>
                    </tr>
