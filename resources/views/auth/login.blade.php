    ...
    <div class="card font-roboto card-shadow z-depth-0">
        <div class="card-body pt-0 px-4 pb-4">
            <div class="text-center">
                <img class="img-responsive rounded-circle bg-white p-2" src="{{ asset('assets/img/nep-gov-logo-sm.png') }}" alt="" style="height: 100px; width: 110px; margin-top: -30px;">
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input type="text" id="username" name="username" class="form-control grey lighten-5 p-4  @error('username') is-invalid @enderror" placeholder="Username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                    @error('username')
