...
<div class="container-fluid">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">खानेपानी तथा  सरसफाई डिविजन कार्यालय </li>
        </ol>
    </nav>
    ...
    <div class="card z-depth-0">
        <div class="card-header">
            <div class="d-flex">
                <h1 class="h3-responsive d-inline-block">खानेपानी तथा  सरसफाई डिविजन कार्यालय परियोजनाहरू</h1>
                <div class="ml-auto">
        ...
        <div class="card-body" style="overflow-x: auto;">
            <table class="table table-striped table-hover" style="width: 2000px;">
                ...
                <tbody>
                    @forelse ($drinkingWaterOffices as $item)
                    <tr>
